    ...
    if(isset($_GET['q'])){
        if ($_GET['q'] == 'success'){
            echo "<div class='alert alert-success'>
                ...
                <button class='close' data-close='alert'></button> Customer already exists in Customer!</div>";
            }
        }
...
?>                                          
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <textarea name="customer_address" id="" cols="30" class="form-control" rows="5" placeholder="Customer Address"></textarea> </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-md-3">Customer Email</label>
                                                <div class="col-md-4">
                                                    <input type="email" name="customer_email" class="form-control" placeholder="Customer Email" /> </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="customer_contact" class="form-control" placeholder="Customer Contact" /> </div>
                                            </div>
                                            <div class="form-group">
