        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="portlet">
                            <a href="add-supplier.php" class="btn red">
                                                    ...
                                                    <div class="form-body">
                                                       <div class="form-group clearfix">
                                                        ...
                                                        <div class="form-group clearfix">
                                                            ...
                                                            <div class="col-md-9">
                                                                <textarea name="supplier_address" id="supplier_address" cols="30" class="form-control" rows="5" placeholder="Supplier Address"></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group clearfix">
...
<![endif]-->
    ...
    toastr["success"]("You have Successfully Edited!!!", "Supplier Edit!!!")
    </script>
    <?php
    ...
    toastr["success"]("You have Successfully Deleted!!!", "Supplier Delete!!!")
    </script>
    <?php
    unset($_SESSION['status']);
    }
