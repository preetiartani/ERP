                   ...
                   <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <li class="nav-item  <?php echo ($page == "product"?'active':'');?>">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  <?php echo ($sub_page == "add-product"?'open':'');?>">
                                    <a href="add-product.php" class="nav-link ">
                                        <span class="title">Add Product</span>
                                    </a>
                                </li>
                                <li class="nav-item <?php echo ($sub_page == "manage-prod"?'open':'');?> ">
                        ...
                        <li class="nav-item  <?php echo ($page == "customer"?'active':'');?>">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item <?php echo ($sub_page == "add-cust"?'open':'');?>">
                                    <a href="add-customer.php" class="nav-link ">
                                        <span class="title">Add Customer</span>
                                    </a>
                                </li>
                                <li class="nav-item <?php echo ($sub_page == "manage-cust"?'open':'');?>">
                        ...
                        <li class="nav-item  <?php echo ($page == "supplier"?'active':'');?>">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item  <?php echo ($sub_page == "add-supp"?'open':'');?>">
                                    <a href="add-supplier.php" class="nav-link nav-toggle">
                                        <span class="title">Add Supplier</span>
                                    </a>
                                </li>
                                <li class="nav-item  <?php echo ($sub_page == "manage-supp"?'open':'');?>">
                                    <a href="manage-supplier.php" class="nav-link nav-toggle">
