                                                    ...
                                                    <div class="form-body">
                                                       <div class="form-group clearfix">
                                                        ...
                                                        <div class="form-group clearfix">
                                                            ...
                                                            <div class="col-md-9">
                                                                <textarea name="customer_address" id="customer_address" cols="30" class="form-control" rows="5" placeholder="Customer Address"></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group clearfix">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button id="edit_save" type="submit" class="btn btn-primary" name="edit_customer">Save changes</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
...
<![endif]-->
    ...
    toastr["success"]("You have Successfully Edited!!!", "Customer Edit!!!")
    </script>
    <?php
    ...
    toastr["success"]("You have Successfully Deleted!!!", "Customer Delete!!!")
    </script>
    <?php
    unset($_SESSION['status']);
    }
