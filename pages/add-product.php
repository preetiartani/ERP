...
<span class="required"> * </span>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label class="col-md-4 control-label">Sale Rate</label>
                    <div class="col-md-8">
           ...
           <div class="row">
                           ...
                           <option></option>
                            <?php
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    $catgeory_id = $row['category_id'];
                                    $category_name = $row['category_name'];
                                    echo "<option value='$catgeory_id'>$category_name</option>";
                                }
                            ?>
                        </select>
                    </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label class="col-md-4 control-label">EOQ</label>
                    <div class="col-md-8">
                        <input type="text" id="eoq" name="eoq" class="form-control" placeholder="EOQ" value="0" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                    <textarea name="additional_specification" id="additional_specification" class="form-control" rows="3"></textarea>
                     </div>
                </div>
            </div>
        </div>
