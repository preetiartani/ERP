                                                ...
                                                <form action="http://<?php echo BASE_SERVER; ?>/erp/pages/scripts/product/edit.php" method="POST">
                                                    <div class="form-body">
                                                       <div class="form-group clearfix">
                                                        ...
                                                        <div class="form-group clearfix">
                                                            <label class="control-label col-md-3">EOQ</label>
                                                            <div class="col-md-9">
                                                                <input type="text" id="eoq" class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="form-group clearfix">
                                                            <label class="control-label col-md-3">Sale Rate</label>
                                                            <div class="col-md-9">
                                                                <input type="text" id="sale_rate" name="sale_rate" class="form-control" placeholder="Sale Rate" /> </div>
                                                        </div>
                                                        <div class="form-group clearfix">
                                                            <label class="control-label col-md-3">Additional Specification<span class="required"> * </span></label>
                                                            <div class="col-md-9">
                                                                <textarea name="additional_specification" id="" cols="30" rows="10" class="form-control"></textarea>
                                                                </div>
                                                        </div>
...
<![endif]-->
    ...
    toastr["success"]("You have Successfully Edited!!!", "Product Edit!!!")
    </script>
    <?php
    ...
    <?php
    if(isset($_SESSION['status']) && $_SESSION['status'] == PRODUCT_DELETE_SUCCESS){
    ?>
    <script>
        toastr.options = {
              "closeButton": true,
    ...
    toastr["success"]("You have Successfully Deleted!!!", "Product Delete!!!")
    </script>
    <?php
    unset($_SESSION['status']);
    }
